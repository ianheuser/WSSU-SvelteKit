export const programs = [
	...
	},
    {
        ...
        affordabilityHeader: "AFFORDABILITY WITHOUT COMPROMISE",
        affordabilityCopy: "Our graduate programs are among the most affordable in the Piedmont Triad region. From competitive tuition and financial aid to paid research assistantships funded through faculty grants, we offer options that put your graduate degree within reach.",
...

    {
        ...
        type: 'Doctorate',
        heading: 'Doctor',
        subHeading: 'of Physical Therapy',
		href: '/programs/dpt',
        programCode: 'dpt',
